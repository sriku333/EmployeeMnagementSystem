...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Page<EmployeeDTO> findAll(Pageable pageable) {
        ...
        return employeeRepository.findByOrderBySalaryDescNameAsc(pageable).map(employeeMapper::toDto);
    }
    ...
    @Override
    public Optional<EmployeeDTO> findByEmployeeId(String id){
        log.debug("employeeid : ",id);
        return employeeRepository.findByEmployeeId(id).map(employeeMapper::toDto);
    }
}
