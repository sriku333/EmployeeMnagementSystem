...
class EmployeeResourceIT {
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.employeeId(UPDATED_EMPLOYEE_ID).name(UPDATED_NAME).salary(UPDATED_SALARY).designation(UPDATED_DESIGNATION);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.employeeId(UPDATED_EMPLOYEE_ID).name(UPDATED_NAME).salary(UPDATED_SALARY).designation(UPDATED_DESIGNATION);
